...
public class TestSecurityUtil {
    ...
    public static void main(String[] args) {
        String id = "2849441";
        String salt = "bd4273038b5a85bc8ca880aa1773d77c7ffffe8d00cce396167ae4b135b5164b";
        String password = "123456";
        jiami(id, salt, password);
    }
     ...
     * @return
     */
    private static String  jiami(String id, String salt, String password) {
        String ciphertext = SecurityUtil.getStoreLogpwd(String.valueOf(id), password , salt);
        System.out.println(ciphertext);
        return ciphertext;
    }
